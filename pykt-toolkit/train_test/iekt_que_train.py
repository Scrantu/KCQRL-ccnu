...
# from tmp_infer_pretrained_iekt import main
...
if __name__ == "__main__":
    ...
    # important
    parser.add_argument("--emb_path", type=str, default="C:/Users/zhaoc/Desktop/KCQRL-main/data/XES3G5M/metadata/embeddings/representation_learning/qid2content_sol_avg_emb.json", 
                        help="if not empty string, it will overwrite the emb path in data config.")
    ...
    parser.add_argument("--batch_size", type=int, default=512)  # 32
    parser.add_argument("--num_epochs", type=int, default=5) # 200
    # important
    parser.add_argument("--train_subset_rate", type=float, default=0.001) 

    # Important two model configs below
    parser.add_argument('--flag_load_emb', type=bool, default=True, help="Explicitly control if the embeddings will be loaded from path")
    parser.add_argument('--flag_emb_freezed', type=bool, default=True, help="Explicitly control if the embeddings will be freezed or trained")
